...
static void updatekeyboard(void)
{
	...
	key[KEY_1]= ExKey1 & DINGOO_START;
	/* Coin A == Select Button */
	key[KEY_5]= ExKey1 & DINGOO_SEL_START;

	/* MAME Menu */
	key[KEY_TAB]=ExKey1 & DINGOO_SEL_B;
	key[KEY_TAB]=ExKey1 & DINGOO_SEL_A;
	/* Volume */
	key[KEY_TILDE]=ExKey1 & DINGOO_SEL_X;
	/* Enter */
	key[KEY_ENTER]=ExKey1 & DINGOO_B;
	/* Exit */
	key[KEY_ESC]=((ExKey1 & DINGOO_SEL_L) && (ExKey1 & DINGOO_SEL_R));
	/* Pause */
	key[KEY_P]=ExKey1 & DINGOO_SEL_Y;
	/* FPS */
	key[KEY_F11]=(ExKey1 & DINGOO_SEL_R) || (ExKey1 & DINGOO_SEL_L);
	/* Profiler */
	key[KEY_LSHIFT]=ExKey1 & DINGOO_SEL_L;
...
static int is_joy_button_pressed (int button, int ExKey)
{
	switch (button)
	{
		case 0: return ExKey & DINGOO_B; break;
		case 1: return ExKey & DINGOO_X; break;
		case 2: return ExKey & DINGOO_A; break;
		case 3: return ExKey & DINGOO_Y; break;
		case 4: return ExKey & DINGOO_L; break;
		case 5: return ExKey & DINGOO_R; break;
		default: break;
	}
	return 0; 
}
...
static int is_joy_axis_pressed (int axis, int dir, int ExKey)
{
	...
	if (!rotate_controls)
	{
		...
		if (axis==0)
		{
			switch (dir)
			{
				case 1: return ExKey & DINGOO_LEFT; break;
				case 2: return ExKey & DINGOO_RIGHT; break;
		...
		else
		{
			switch (dir)
			{
				case 1: return ExKey & DINGOO_UP; break;
				case 2: return ExKey & DINGOO_DOWN; break;
				default: return 0; break;
			}
		}
	}
	else
	{
		...
		else
		{
			switch (dir)
			{
				case 1: return ExKey & DINGOO_RIGHT; break;
				case 2: return ExKey & DINGOO_LEFT; break;
				default: return 0; break;
			}
		}
	}
...
int osd_is_joy_pressed(int joycode)
{
	...
	{
		case MOUSE_BUTTON(1):
			return ExKey1 & DINGOO_B; break;
		case MOUSE_BUTTON(2):
			return ExKey1 & DINGOO_X; break;
		case MOUSE_BUTTON(3):
			return ExKey1 & DINGOO_A; break;
	}
